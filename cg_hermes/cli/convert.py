...
from cg_hermes.validate import validate_mip_deliverables
...
def convert_cmd(
    infile: Path, pipeline: Pipeline = typer.Option(Pipeline.mip), outfile: Optional[Path] = None
):
    ...
    try:
        deliverables = validate_mip_deliverables(deliverables_raw)
