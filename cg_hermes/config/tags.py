...
ANALYSIS_COMMON = {
    ...
    "circular": {"description": "Circular plot"},
    "profile": {"description": "Copy number profile"},
    "raw-profile": {"description": "Copy number profile without rounding to whole numbers"},
    "aspcf": {"description": "Plot of LogR and BAF values"},
    "sunrise": {"description": "Sunrise plot"},
