...
REPORTING_COMMON = {
    ...
    "general-stats": {"description": "General statistics reported from MultiQC"},
    ...
    "picard-rnaseq": {"description": "Metrics about the alignment of RNA-seq reads"},
    ...
    "star": {"description": "Files related to Star aligner"},
