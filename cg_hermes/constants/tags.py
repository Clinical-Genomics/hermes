...
class VariantTags(StrEnum):
    ...
    VCF_MT: str = "vcf-mt"
    VCF_MT_INDEX: str = "vcf-mt-index"
    VCF_MT_CLINICAL: str = "clinical-mt"
    VCF_MT_CLINICAL_INDEX: str = "clinical-mt-index"
    VCF_MT_RESEARCH: str = "research-mt"
    VCF_MT_RESEARCH_INDEX: str = "research-mt-index"
    VCF_SNV: str = "vcf-snv"
