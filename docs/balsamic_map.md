...
| clinical-cnv-report-pdf, cnv-report-pdf                        | True        | cnv-report                                | deliver, scout (for WES/TGS only) |
| clinical-cnv-report-html, cnv-report-html                      | True        | cnv-report                                | deliver, scout                    |
